...
//
//         var data = mlContext.Data.CreateEnumerable<DengueForecastInput>(dataView, reuseRowObject: false);
//
...
//         .Append(mlContext.Transforms.CustomMapping<DengueForecastInput, IsWetWeekTransformed>(
...
//
//         var predictor = mlContext.Model.CreatePredictionEngine<DengueForecastInput, DengueForecastOutput>(model);
//

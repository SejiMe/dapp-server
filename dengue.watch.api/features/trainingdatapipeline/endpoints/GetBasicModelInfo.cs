...
public class GetBasicModelInfo : IEndpoint
{
    ...
    private static Results<Ok<ModelInfo>, ProblemHttpResult> Handler([FromServices] IPredictionService<GetBasicModelInfo, DengueForecastOutput> _predictionService)
    {
        try
        {
